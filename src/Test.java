...
public class Test {
    public static void main(String []argvs) throws Exception{
        ...
        for(int i = 0;i<regulationStorager.regulationRecords.size();i++){
            ...
            String line = r.wordName+","+r.regulationDocName+","+r.contexId+","+"\""+r.rawWordContext.substring(0,r.rawWordContext.length()-1)+"\"\n";
            storageWriter.append(line);
        }
        storageWriter.close();
//        submitter.build();
//        SimSearcher searcher = new SimSearcher(builder,submitter);
